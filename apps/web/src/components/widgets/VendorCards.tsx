        ...
        return (
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#6b7280' }}>
              ...
              <span style={{ color: '#9ca3af' }}>({reviewCount ?? 0} reviews)</span>
            </div>
            ...
            <div style={{
              ...
              {verification?.verified && (
                <span style={{ display: 'flex', alignItems: 'center', gap: '0.25rem', color: '#22c55e', fontSize: '0.75rem' }}>
                  <span style={{ fontSize: '0.875rem' }}>✓</span> Verified
                </span>
              )}
              {booleans?.is_agency_insured && (
                <span style={{ display: 'flex', alignItems: 'center', gap: '0.25rem', color: '#22c55e', fontSize: '0.75rem' }}>
                  <span style={{ fontSize: '0.875rem' }}>✓</span> Insured
                </span>
              )}
              {booleans?.free_in_home_evaluation && (
                <span style={{ display: 'flex', alignItems: 'center', gap: '0.25rem', color: '#3b82f6', fontSize: '0.75rem' }}>
                  <span style={{ fontSize: '0.875rem' }}>🏠</span> Free In-Home Evaluation
                </span>
              )}
              {booleans?.can_request_same_caregiver && (
                <span style={{ display: 'flex', alignItems: 'center', gap: '0.25rem', color: '#6b7280', fontSize: '0.75rem' }}>
                  <span style={{ fontSize: '0.875rem' }}>👤</span> Same Caregiver Available
                </span>
              )}
            </div>
          </div>
